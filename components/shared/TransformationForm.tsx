"use client";
import React, { startTransition, useState, useTransition, useEffect } from "react";
import { z } from "zod";
            ...
            <CustomField
              ...
              render={({ field }) => (
                <Input
                  ...
                  onChange={(e) => onInputChangeHandle("prompt", e.target.value, type, field.onChange)}
                />
              )}
            />
            {type === "recolor" && (
              <CustomField
                ...
                render={({ field }) => (
                  <Input
                    value={field.value}
                    className="input-field"
                    onChange={(e) => onInputChangeHandle("color", e.target.value, "recolor", field.onChange)}
                  />
                )}
              />
            )}
